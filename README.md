...
The code in this repository is released under the [MIT](https://github.com/adnan-muhammadi/client-portfolio-2023/blob/main/MIT.md) License, which grants you the freedom to use, modify, and distribute the template as your own. However, if you choose to use the site's design largely unmodified, kindly credit me as the original designer of the site.
...
- Click [here](https://therizwan.vercel.app/) to view the live demo.
...
- [git](https://git-scm.com/) command to clone the files to your machine:

```
git clone https://github.com/adnan-muhammadi/client-portfolio-2023/
```
...
- GitHub: [@adnan](https://github.com/adnan-muhammadi)
- Twitter: [@adnan_muhamadi](https://twitter.com/@adnan_muhamadi)
- LinkedIn: [Rizwan Saleem](https://www.linkedin.com/in/therizwansaleem/)
